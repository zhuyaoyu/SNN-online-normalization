...
def main():
    ...
    out_dir = os.path.join(args.out_dir, f'{args.model}_{args.cnf}_T_{args.T}_T_train_{args.T_train}_{args.opt}_lr_{args.lr}_tau_lvl_{args.tau_online_level}_w_lvl_{args.weight_online_level}_')
