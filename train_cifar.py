...
def main():
    ...
    net = spiking_vgg.__dict__[args.model](single_step_neuron=neuron.OnlinePLIFNode, tau=args.tau, surrogate_function=surrogate.Sigmoid(), track_rate=True, c_in=3, num_classes=num_classes, neuron_dropout=args.drop_rate, fc_hw=1, v_reset=None, BN=args.BN, weight_standardization=args.WS, detach_reset=not args.BPTT)
    #print(net)
